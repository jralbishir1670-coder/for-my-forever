          ...
          {categories.map((category) => {
            ...
            return (
              <button
                ...
                className={`min-h-12 shrink-0 rounded-full border px-4 text-xs font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#be185d] ${
                  isActive
